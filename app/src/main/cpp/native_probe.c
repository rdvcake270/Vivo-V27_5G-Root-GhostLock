...
Java_com_ankitrawatgit_iqoo9rootghostlock_NativeProbe_run(JNIEnv *env, jobject thiz) {
  (void)thiz;
  char output[8192] = {0};
...
Java_com_ankitrawatgit_iqoo9rootghostlock_NativeProbe_isKernelSuActive(JNIEnv *env,
                                                       jobject thiz) {
  (void)env;
  (void)thiz;
