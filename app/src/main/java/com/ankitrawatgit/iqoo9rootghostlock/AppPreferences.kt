...
object AppPreferences {
    ...
    fun shizukuMode(context: Context): Boolean =
        context.getSharedPreferences(PREFERENCES, Context.MODE_PRIVATE)
            // The APK path cannot access tracefs from the untrusted_app domain.
            // Keep the supported execution path enabled for fresh installs.
            .getBoolean(SHIZUKU_MODE, true)
